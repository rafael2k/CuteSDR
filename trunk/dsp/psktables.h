...
const quint16 VARICODE_TABLE[256] = {
	...
	0xB5B0	// ASCII = 255	10110101101100
}; 

// reverse varicode table for decoding back to character
// genreated with:
...
//	for( int i=0; i<256;i++)
//	{
//		quint16 wTemp = VARICODE_TABLE[i];
//		while( !(wTemp&1) )
//			wTemp >>= 1;
//		wTemp >>= 1;
//		if( wTemp == j)
//			m_VaricodeDecTbl[j] = (quint8)i;
//	}
//}
const quint8 VARICODE_DEC_TABLE[2048] = {
...
static const quint8 ConvolutionCodeTable[32] =
{
	2, 1, 3, 0, 3, 0, 2, 1,
	0, 3, 1, 2, 1, 2, 0, 3,
	1, 2, 0, 3, 0, 3, 1, 2,
...
{
	TYPEREAL Pathdistance;	// sum of all metrics for a given survivor path
...
#define SYM_ON 4		//Full output
#define SYM_OFF 5		//No output
